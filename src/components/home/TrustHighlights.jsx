...
export default function TrustHighlights() { 
  return ( 
    <section className="relative overflow-hidden w-[1340px] mx-auto h-[606px] font-display"> 
      {/* Background image swaps with the theme */} 
      <img 
        src={parking} 
        alt="" 
        className="dark-only absolute inset-0 w-full h-full object-cover z-0" 
      /> 
      <img 
        src={parkingLight} 
        alt="" 
        className="light-only absolute inset-0 w-full h-full object-cover z-0" 
      /> 
 
      {/* Theme-specific image overlay */} 
